    ...
    for (int r = 0; r < m.getNumRows(); r++) {
        for (int c = 0; c < m.getNumCols(); c++) {
            if (r == r_check && c == c_check) {
                ...
                // printf("failed at %d, %d while checking %d, %d in direction %d\n", r, c, r_check, c_check, dir_check);
                // if (m.hasWall(r, c, Direction::NORTH))
                // {
                //     printf("thought there was a wall NORTH of %d, %d\n", r, c);
                // }
                // else if (m.hasWall(r, c, Direction::EAST))
                // {
                //     printf("thought there was a wall EAST of %d, %d\n", r, c);
                // }
                // else if (m.hasWall(r, c, Direction::SOUTH))
                // {
                //     printf("thought there was a wall SOUTH of %d, %d\n", r, c);
                // }
                // else if (m.hasWall(r, c, Direction::WEST))
                // {
                //     printf("thought there was a wall WEST of %d, %d\n", r, c);
                //     printf("array idx: %d\n", m.getArrayIndex(m.getWallArrayCoord(r, c, Direction::WEST)));
                // }
                return false;
            }
        }
